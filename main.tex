...
\rowcolor[gray]{.95}nearEdge & 0.006 & 0.005 & 0.008 & 0.002 & 0.086$^{*}$ & 0.089$^{*}$ & 0.023  \\ 
 ...
 \rowcolor[gray]{.95}Intercept & $-$1.388$^{***}$ & $-$1.203$^{***}$ & $-$1.358$^{***}$ & $-$1.256$^{***}$ & $-$1.006$^{***}$ & $-$0.836$^{**}$ & $-$1.285$^{***}$ \\   
 \hline \\[-1.8ex] 
...
\\[-1.8ex] & TLP & LDMC & SLA & RDMC & RTD & SRL & RDiam\\ 
\hline \\[-1.8ex] 
 \rowcolor[gray]{.95}size$_{t}$ & 0.512$^{***}$ & 0.513$^{***}$ & 0.509$^{***}$ & 0.510$^{***}$ & 0.561$^{***}$ & 0.562$^{***}$ & 0.489$^{***}$ \\
 neighbors\_10 & $-$0.122$^{***}$ & $-$0.122$^{***}$ & $-$0.124$^{***}$ & $-$0.124$^{***}$ & $-$0.127$^{***}$ & $-$0.127$^{***}$ & $-$0.127$^{***}$ \\ 
 \rowcolor[gray]{.95}nearEdge & $-$0.003 & $-$0.003 & $-$0.005 & $-$0.005 & $-$0.027 & $-$0.027 & $-$0.023  \\ 
 \textbf{SPEI:trait} & $-$0.016 & 0.046$^{**}$ & $-$0.008 & $-$0.004 & $-$0.007  & 0.012 & 0.008 \\ 
\rowcolor[gray]{.95} SPEI\_s & 0.111$^{***}$ & 0.124$^{***}$ & 0.123$^{***}$ & 0.117$^{***}$ & 0.071 & 0.073$^{*}$ & 0.048  \\ 
 \textbf{trait} & $-$0.162$^{**}$ & 0.115 & 0.054 & 0.044 & $-$0.197$^{**}$ & $-$0.092 & 0.020  \\ 
 \rowcolor[gray]{.95} Intercept & 1.338$^{***}$ & 1.403$^{***}$ & 1.247$^{***}$ & 1.300$^{***}$ & 1.071$^{***}$ & 0.973$^{**}$ & 1.301$^{***}$ \\ 
 \hline \\[-1.8ex] 
  $\tau_{00}$ & 0.02$_{quad}$ & 0.02$_{quad}$ & 0.02$_{quad}$ & 0.02$_{quad}$ & 0.02$_{quad}$ & 0.02$_{quad}$ & 0.02$_{quad}$ \\
  & 0.03$_{year}$ & 0.02$_{year}$ & 0.02$_{year}$ & 0.02$_{year}$ & 0.03$_{year}$ & 0.03$_{year}$ & 0.04$_{year}$ \\
  & 0.71$_{spp.}$ & 0.57$_{spp.}$ & 0.54$_{spp.}$ & 0.53$_{spp.}$ & 0.34$_{spp.}$ & 0.49$_{spp.}$ & 0.76$_{spp.}$\\
  \rowcolor[gray]{.95}$\tau_{11}$ & 0.06 $_{size_t*spp}$ & 0.06$_{size_t*spp}$ & 0.06$_{size_t*spp}$ &
  0.06$_{size_t*spp}$ & 0.08$_{size_t*spp}$ & 0.07$_{size_t*spp}$ & 0.08$_{size_t*spp}$ \\
...
% old version of growth model results
%\begin{table}[h] \centering 
