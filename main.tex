...
\item  Plant size had consistently positive effects on survival across all species. Local intraspecific competition had consistently negative effects on growth and survival across all species. Graminoids with more negative leaf TLP and higher LDMC and RDMC had higher survival rates in dry years, while graminoids with less negative leaf TLP and lower LDMC and RDMC had higher survival rates in wet years. Graminoids with more negative leaf TLP and higher LDMC had slower growth rates in dry years, while graminoids with less negative leaf TLP and lower LDMC had higher growth rates in wet years.
\item 
\item  Forbs demonstrated similar yet more variable responses to inter-annual climate.  
...
\\[-1.8ex] & TLP & LDMC & SLA & RDMC & RTD & SRL & RDiam\\ 
\hline \\[-1.8ex] 
 neighbors & $-$0.45$^{**}$ & $-$0.53$^{***}$ & $-$0.49$^{***}$ & $-$0.49$^{***}$ & $-$0.43$^{**}$ & $-$0.45$^{**}$ & $-$0.38$^{**}$ \\ 
 \rowcolor[gray]{.95}nearEdge & $-$0.49$^{*}$ & $-$0.46 & $-$0.53$^{*}$ & $-$0.48$^{*}$ & $-$0.44 & $-$0.49 & $-$0.47$^{*}$ \\ 
 \textbf{SPEI:trait} & 0.26$^{**}$ & $-$0.51$^{***}$ & 0.73$^{***}$ & $-$0.44$^{***}$ & $-$0.41$^{***}$ & 0.39$^{***}$ & $-$0.02\\ 
 \rowcolor[gray]{.95}SPEI & 0.16 & 0.27$^{*}$ & 0.36$^{**}$ & 0.16 & 0.20 & 0.21 & 0.13 \\  
  \textbf{trait} & 0.01 & -0.16 & 0.33 & -0.48 & 0.17 & 0.06 & 0.09 \\
 \rowcolor[gray]{.95}Intercept & $-$1.78$^{**}$ & $-$1.82$^{**}$ & $-$1.62$^{**}$ & $-$2.12$^{***}$ & $-$0.79 & $-$1.84$^{*}$ & $-$1.60$^{**}$ \\ 
\hline \\[-1.8ex] 
  $\tau_{00}$ & 0.45$_{quad}$ & 0.43$_{quad}$ & 0.45$_{quad}$ & 0.43$_{quad}$ & 0.50$_{quad}$ & 0.51$_{quad}$ & 0.47$_{quad}$ \\
  & 0.15$_{year}$ & 0.17$_{year}$ & 0.13$_{year}$ & 0.15$_{year}$ & 0.20$_{year}$ & 0.20$_{year}$ & 0.14$_{year}$ \\
  & 2.68$_{spp.}$ & 2.21$_{spp.}$ & 2.55$_{spp.}$ & 2.60$_{spp.}$ & 1.36$_{spp.}$ & 4.16$_{spp.}$ & 2.76$_{spp.}$\\
\hline \\[-1.8ex] 
\rowcolor[gray]{.95} Residual Variance & 3.29 & 3.29 & 3.29 & 3.29 & 3.29 & 3.29 & 3.29\\
n & 565 & 565 & 565 & 565 & 454 & 480 & 522 \\ 
\rowcolor[gray]{.95} Marg./Cond. $R^2$ & 0.03/0.51 & 0.06/0.50 & 0.06/0.52 &	0.07/0.53 & 0.05/0.42 &	0.03/0.61 &	0.01/0.51\\
