...
\title{Leaf turgor loss point and tissue dry matter content mediate the effect of drought on grassland herbaceous plant survival} %is it good to include the study system here? since our analysis is confined to this system?
...
\begin{abstract}
\begin{enumerate}
\item Global climate change increases the likelihood of extreme weather events and exacerbates variability in inter-annual climate, which in turn impacts plant population dynamics and community composition. Previous work has characterized broad relationships between plant traits and regional climate, but has largely ignored how traits mediate the effect of abiotic conditions on population dynamics. Mechanistic predictions of plant community structure and function in changing environment depend on a mechanistic understanding of the demographic response of each species in that community responds to abiotic conditions. We quantify the relative importance of leaf and root functional traits for predicting species growth and survival in response to drought, providing insight into drought tolerance mechanisms and refining our ability to predict population and community responses to changing drought regimes.
\item We predicted that turgor loss point (TLP), a trait directly related to water use, will best predict changes in plant growth and survival in response to drought. Low TLP species will have a higher probability of growth and survival in dry years than high TLP species. We also predicted that leaf and root dry matter content (LDMC and RDMC) will affect responses to drought, since plants with higher rates of carbon allocation to cell walls will have higher wilting resistance.
\item We synthesized 15 years of demographic data, species-level morphological and physiological functional trait measurements, and records of annual climate variability in a short-grass steppe ecosystem in northern Colorado (COSGS). We calculated the Standardized Precipitation Evapotranspiration Index (SPEI) for each growing season as a measure of drought intensity. We fit Generalized Linear Mixed Effect Models that account for the effect of plant size and local neighborhood competition to determine whether traits interact with growing-season water availability to impact growth and survival.
\item  The impact of trait on survival varied significantly across a gradient of SPEI for TLP, LDMC, and RDMC. Individuals with more negative TLP and higher LDMC and RDMC had higher survival rates in drier years, while the inverse was true in wet years. The morphological traits  LDMC and RDMC, had a stronger effect on survival than TLP, a physiological trait. This contradicted our predictions, and might indicate that leaf and root structural integrity is more important than osmotic maintenance for maintaining turgid leaves under water stress. %if it's a better predictor, isn't it also more important?
\item  We identified neither direct nor interactive effects of any functional trait on growth, which suggests that if an individual survives drought in this system, it is able to grow or maintain its size.   %how else would we describe the effect of drought on survival but not on growth? trying to say that those species that do survive to the next year are fine and experience no adverse effect of drought on growth
