...
\begin{table}[h] \centering 
 \caption{\internallinenumbersGraminoid Graminoid Survival Model Coefficients} 
 \label{ModResults} 
 \resizebox{\textwidth}{!}{%
