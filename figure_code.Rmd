...
Make plot of effect of size_t on size_t+1 using coefficients from TLP model, as well as raw data
```{r}
#model is mGrowTLP
...
Make a figure showing the fitted relationship between size_t and size_t+1 for each graminoid species
```{r}
...
```{r growthEffectPlots, fig.width=9, fig.height=3}
