...
```{r mainObservationsFig, fig.width=8, fig.height=7}
(mainObs <- ggarrange(gramSurvFigure, forbSurvFigure, ncol = 1, nrow = 2, heights = c(.9,1)))
```
...
```{r survEffectPlots, fig.width=7, fig.height=3}
