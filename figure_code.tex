...
\NormalTok{mainObs \textless{}{-}}\StringTok{ }\KeywordTok{ggdraw}\NormalTok{(}\KeywordTok{add\_sub}\NormalTok{(mainObs, }\DataTypeTok{label =} \KeywordTok{bquote}\NormalTok{(}\StringTok{"scaled(Root Tissue Density) (g/c"}\OperatorTok{*}\NormalTok{m}\OperatorTok{\^{}}\DecValTok{3}\OperatorTok{*}\StringTok{")"}\NormalTok{),}\DataTypeTok{x =} \FloatTok{.5}\NormalTok{, }\DataTypeTok{y =} \DecValTok{9}\NormalTok{, }\DataTypeTok{size =} \DecValTok{9}\NormalTok{))}
