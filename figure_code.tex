...
\StringTok{  }\KeywordTok{geom\_hline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{3.54}\NormalTok{), }\DataTypeTok{col =} \StringTok{"darkgrey"}\NormalTok{, }\DataTypeTok{lty =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\CommentTok{\# add an hline to show the average size\_t, which is 3.545 }
\StringTok{  }\KeywordTok{geom\_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{ymin =}\NormalTok{ CI\_low, }\DataTypeTok{ymax =}\NormalTok{ CI\_high, }\DataTypeTok{fill =}\NormalTok{ SPEI), }\DataTypeTok{alpha =} \FloatTok{0.3}\NormalTok{)}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Prob.(Graminoid Survival)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale\_color\_brewer}\NormalTok{(}\DataTypeTok{palette =} \StringTok{"Set2"}\NormalTok{) }\CommentTok{\#+}
  \CommentTok{\#theme(axis.ticks.x.bottom = element\_blank(),}
        \CommentTok{\#axis.text.x.bottom = element\_blank(),}
...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\CommentTok{\#axis.ticks.x.bottom = element\_blank(),}
        \CommentTok{\#axis.text.x.bottom = element\_blank(),}
...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\CommentTok{\#axis.ticks.x =element\_blank(),}
...
\StringTok{  }\KeywordTok{geom\_abline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{slope =} \DecValTok{1}\NormalTok{, }\DataTypeTok{intercept =} \DecValTok{0}\NormalTok{), }\DataTypeTok{lty =} \DecValTok{2}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{.8}\NormalTok{) }\OperatorTok{+}
...
\CommentTok{\#make abbreviated species names}
...
\StringTok{  }\KeywordTok{geom\_abline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{slope =} \DecValTok{1}\NormalTok{, }\DataTypeTok{intercept =} \DecValTok{0}\NormalTok{), }\DataTypeTok{lty =} \DecValTok{2}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{.8}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\CommentTok{\#geom\_point(aes(x = size\_t\_log, y = size\_tplus1\_log, col = sppName), alpha = .3) +}
